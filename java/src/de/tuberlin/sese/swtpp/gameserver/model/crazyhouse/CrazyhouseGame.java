...
public class CrazyhouseGame extends Game implements Serializable {
	...
	public CrazyhouseGame() {
		super();
		board = BoardParser.parse("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR/", this);
	}
	...
	public void setBoard(String state) {
		...
		this.board = BoardParser.parse(state, this);
	}

	@Override
	public String getBoard() {
		return BoardParser.parse(board);
	}

	@Override
	public boolean tryMove(String moveString, Player player) {
		if (nextPlayer != player) return false;
		return board.tryMove(moveString);
	}
